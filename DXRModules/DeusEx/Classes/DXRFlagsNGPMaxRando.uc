...
function NewGamePlus()
{
    ...
    if(maxrando > 0) {
        ...
        newgameplus_max_item_carryover = newgameplus_max_item_carryover;
        newgameplus_num_skill_downgrades = newgameplus_num_skill_downgrades;
        newgameplus_num_removed_augs = newgameplus_num_removed_augs;
        newgameplus_num_removed_weapons = newgameplus_num_removed_weapons;
